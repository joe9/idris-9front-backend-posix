...
all:
        ...
        cp src/rts/*.[ch] patched-rts/
        ape/patch --verbose '--directory=patched-rts' '--input=../src/rts/idris_opts_function_without_return.patch'
        ape/patch --verbose '--directory=patched-rts' '--input=../src/rts/idris_stdfgn_avoid_timeval_usage.patch'
